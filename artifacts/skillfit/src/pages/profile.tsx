...
import { KARNATAKA_DISTRICTS, TRADES } from "@/lib/constants";
    ...
    <div className="min-h-screen bg-[#f7f3ec] px-4 py-6 text-foreground">
      <main className="mx-auto max-w-3xl">
        ...
        <section className="mt-4 rounded-lg border border-[#d9c7ac] bg-white p-5 shadow-sm">
          <p className="text-sm font-bold text-[#24150f]">Interview</p>
          <p className="mt-1 text-sm text-muted-foreground">
            Start the interview only when your profile is ready.
          </p>
