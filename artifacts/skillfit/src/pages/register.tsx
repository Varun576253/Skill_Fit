...
export const AADHAAR_SAMPLES: AadhaarProfile[] = [
  {
    ...
    phone: "9876543210",
    district: "Tumakuru",
    trade: "Junior Powerman / Lineman Helper",
    skills: "Electrical helper, safety checks, pole support, Kannada communication",
  ...
  },
  {
    ...
    phone: "9876501234",
    district: "Belagavi",
    trade: "Police Constable Support Staff",
  ...
  },
  {
    ...
    phone: "9876512345",
    district: "Mysuru",
    trade: "Driver / Vehicle Assistant",
    skills: "Route planning, vehicle cleaning, log book maintenance, passenger support",
...
export default function Register({ mode = "register" }: { mode?: "register" | "login" }) {
  ...
  function applySample(sample: AadhaarProfile) {
